---
description: Internal verification specialist used only when qaas-workflow delegates exact approved restore, build, template, execution, or evidence checks.
