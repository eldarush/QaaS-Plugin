...
# Author an external Type A hook
...
Run only inside a fresh approved implementation or repair envelope.
...
See [Type A boundary](../../references/hooks/type-a-boundary.md).
